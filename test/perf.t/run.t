  ...
  {"sample_id":6,"responses":[{"class":"return","notifications":[],"timing":{"clock":x,"cpu":x,"query":x,"pp":0,"reader":x,"ppx":0,"typer":1,"error":0}}],"merlin_id":1}
  {"sample_id":6,"responses":[{"class":"return","notifications":[],"timing":{"clock":x,"cpu":x,"query":x,"pp":0,"reader":x,"ppx":0,"typer":0,"error":0}}],"merlin_id":0}
  {"sample_id":1,"responses":[{"class":"return","notifications":[],"timing":{"clock":x,"cpu":x,"query":x,"pp":0,"reader":x,"ppx":0,"typer":1,"error":0}}],"merlin_id":1}
  {"sample_id":1,"responses":[{"class":"return","notifications":[],"timing":{"clock":x,"cpu":x,"query":x,"pp":0,"reader":x,"ppx":0,"typer":0,"error":0}}],"merlin_id":0}
  {"sample_id":0,"responses":[{"class":"return","notifications":[],"timing":{"clock":x,"cpu":x,"query":x,"pp":0,"reader":x,"ppx":0,"typer":1,"error":0}}],"merlin_id":1}
  {"sample_id":0,"responses":[{"class":"return","notifications":[],"timing":{"clock":x,"cpu":x,"query":x,"pp":0,"reader":x,"ppx":0,"typer":0,"error":0}}],"merlin_id":0}
