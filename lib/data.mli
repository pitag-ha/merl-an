...
val init : pure:bool -> Fpath.t -> t
(** [init ~pure dir_path] returns a data instance with empty mutable content.
    The provided path [dir_path] is the path of the directory, inside which the
    data will be persisted as json-line-files. If [pure] is true, then updating
    the created data instance will be a pure process, i.e. updating it twice
